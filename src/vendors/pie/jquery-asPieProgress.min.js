...
!(function(t, e) {
    ...
    for (
        var a = ["webkit", "moz"], r = 0; r < a.length && !window.requestAnimationFrame;
        ++r
    ) {
        var o = a[r];
    ...
    var u = function() {
        ...
        f = "createElementNS" in document && new s("svg", {}).createSVGRect,
        c = function(t, e, i, n) {
            var s = function(t, e) {
                    return 1 - 3 * e + 3 * t;
                },
        ...
        m = {
            ease: c(0.25, 0.1, 0.25, 1),
            linear: c(0, 0, 1, 1),
            "ease-in": c(0.42, 0, 1, 1),
            "ease-out": c(0, 0, 0.58, 1),
            "ease-in-out": c(0.42, 0, 0.58, 1),
        },
        d = {
            ...
            numberCallback: function(t) {
                return Math.round(this.getPercentage(t)) + "%";
            },
        ...
        g = (function() {
            function t(n, s) {
                e(this, t),
                    (this.element = n),
                    (this.$element = (0, i.default)(n)),
                    (this.options = i.default.extend(!0, {}, d, s, this.$element.data())),
                    (this.namespace = this.options.namespace),
                    (this.classes = this.options.classes),
                    (this.easing = m[this.options.easing] || m.ease),
                ...
                n(
                    t, [{
                            ...
                            value: function() {
                                f &&
                                    ((this.svg = new s("svg", {
                                        ...
                                        this.buildTrack(),
                                        this.buildBar(),
                                        (0, i.default)('<div class="' + this.classes.svg + '"></div>')
                                        .append(this.svg)
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                for (
                                    var e = arguments.length, i = Array(e > 1 ? e - 1 : 0), n = 1; n < e; n++
                                )
                                    i[n - 1] = arguments[n];
                                var s = [this].concat(i);
                                this.$element.trigger("asPieProgress::" + t, s);
                                var a =
                                    "on" +
                                    (t = t.replace(/\b\w+\b/g, function(t) {
                                        return t.substring(0, 1).toUpperCase() + t.substring(1);
                                    }));
                                "function" == typeof this.options[a] &&
                                    this.options[a].apply(this, i);
                            },
                        },
                        {
                            key: "getPercentage",
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                ...
                                e._frameId = window.requestAnimationFrame(function a(r) {
                                    var o = void 0;
                                    if (r > s) o = t;
                                    else {
                                        var h = (r - n) / e.options.speed;
                                        (o = Math.round(e.easing.fn(h / 100) * (e.max - e.min))),
                                        t > i ?
                                            (o = i + o) > t && (o = t) :
                                            (o = i - o) < t && (o = t);
                                    }
                                    e._update(o),
                                        ...
                                        (e._frameId = window.requestAnimationFrame(a));
                                });
                            },
                        },
                        {
                        ...
                        },
                        {
                            key: "destroy",
                            value: function() {
                                this.$element.data("asPieProgress", null),
                        ...
                        },
                        {
                            key: "setDefaults",
                            value: function(t) {
                                i.default.extend(!0, d, i.default.isPlainObject(t) && t);
                            },
                        },
                    ]
                ),
        ...
        p = { version: "0.4.7" },
        v = i.default.fn.asPieProgress,
        w = function(t) {
            for (
                var e = arguments.length, n = Array(e > 1 ? e - 1 : 0), s = 1; s < e; s++
            )
                n[s - 1] = arguments[s];
            if ("string" == typeof t) {
                var a = t;
                ...
                if (!/^(get)/.test(a))
                    return this.each(function() {
                        var t = i.default.data(this, "asPieProgress");
                        t && "function" == typeof t[a] && t[a].apply(t, n);
                    });
                var r = this.first().data("asPieProgress");
                if (r && "function" == typeof r[a]) return r[a].apply(r, n);
            }
            return this.each(function() {
                (0, i.default)(this).data("asPieProgress") ||
                    (0, i.default)(this).data("asPieProgress", new g(this, t));
            });
        };
    (i.default.fn.asPieProgress = w),
    (i.default.asPieProgress = i.default.extend({
            setDefaults: g.setDefaults,
            registerEasing: g.registerEasing,
            getEasing: g.getEasing,
            noConflict: function() {
                return (i.default.fn.asPieProgress = v), w;
            },
        },
        p
    ));
